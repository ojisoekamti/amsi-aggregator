...
export interface PostCardMetaV4Props {
  className?: string;
...
const PostCardMetaV4: FC<PostCardMetaV4Props> = ({ className = "leading-none", meta, hiddenAvatar = true, size = "normal" }) => {
