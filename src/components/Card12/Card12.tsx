...
const Card12: FC<Card12Props> = ({ className = "h-full", post }) => {
  ...
  return (
    <div className={`nc-Card12 group relative flex flex-col ${className}`} data-nc-id="Card12">
      <Link to={href} className="block flex-shrink-0 flex-grow relative w-full h-0 aspect-w-4 aspect-h-3 rounded-3xl overflow-hidden">
      ...
      <div className=" mt-8 pr-10 flex flex-col">
        ...
        <PostCardMetav3 className="mt-5" meta={post} />
      </div>
    </div>
  );
};
