...
import PostCardSaveAction2 from "components/PostCardSaveAction/PostCardSaveAction2";
import { PostDataType } from "data/types";
import { Link } from "react-router-dom";
import SocialsShare from "components/SocialsShare/SocialsShare";
import PostCardLikeAndComment from "components/PostCardLikeAndComment/PostCardLikeAndComment";
import CardAuthor3 from "components/CardAuthor3/CardAuthor3";
...
const Card23: FC<Card23Props> = ({ className = "h-full", size = "normal", post }) => {
    ...
    >
      ...
      <div className="p-4 sm:p-5 flex flex-col">
        <div className="space-y-3">
          ...
          <CardAuthor3 className="relative my-4" date={date} author={author} />
          <h2
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <PostCardSaveAction2 className="relative" postData={post} readingTime={readingTime} />
        </div>
      </div>
    </div>
  );
