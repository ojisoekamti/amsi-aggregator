...
import WidgetTags2 from "components/WidgetTags/WidgetTags2";
...
import WidgetPosts2 from "components/WidgetPosts/WidgetPosts2";
import WidgetPosts3 from "components/WidgetPosts/WidgetPosts3";
    ...
    <div className={`nc-SectionLatestPosts relative ${className}`}>
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="w-full space-y-7 mt-24 lg:mt-0 lg:w-2/5 lg:pl-10 xl:pl-0 xl:w-1/3 ">
          <WidgetTags2 tags={tags} />
          <WidgetPosts2 posts={widgetPosts} />
          <SectionAds />
          <WidgetPosts3 posts={widgetPosts} />
        </div>
      </div>
    </div>
  );
