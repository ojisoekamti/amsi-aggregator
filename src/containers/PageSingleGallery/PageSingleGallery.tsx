...
const PageSingleGallery: FC<PageSingleGalleryProps> = ({ className = "" }) => {
  ...
  return (
    <>
      <div className={`nc-PageSingleGallery pt-8 lg:pt-16 ${className}`} data-nc-id="PageSingleGallery">
        {/* SINGLE HEADER */}
        <header className="container rounded-xl">
          <SingleHeader metaActionStyle="style2" hiddenDesc pageData={SINGLE_GALLERY} />
          <div className="relative grid grid-cols-3 sm:grid-cols-4 gap-2 my-10">
            ...
            {PHOTOS.filter((_: any, i: number) => i >= 1 && i < 5).map((item, index) => (
