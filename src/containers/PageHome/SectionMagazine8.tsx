...
const postsDemo: PostDataType[] = DEMO_POSTS_AUDIO.filter((_: any, i: number) => i > 7 && i < 17);
...
const SectionMagazine8: FC<SectionMagazine8Props> = ({ posts = postsDemo, className = "" }) => {
  return (
    <div className={`nc-SectionMagazine8 relative ${className}`}>
      <Heading desc={"Click on music icon and enjoy music or podcast"} className="mb-14 text-neutral-900 dark:text-neutral-50">
