...
const postsDemo: PostDataType[] = DEMO_POSTS_GALLERY.filter((_: any, i: number) => i > 7 && i < 17);
...
const SectionMagazine7: FC<SectionMagazine7Props> = ({ posts = postsDemo, className = "" }) => {
  return (
    <div className={`nc-SectionMagazine7 relative ${className}`}>
      <Heading desc={"Over 218 articles has gallery type"} className="mb-14 text-neutral-900 dark:text-neutral-50">
